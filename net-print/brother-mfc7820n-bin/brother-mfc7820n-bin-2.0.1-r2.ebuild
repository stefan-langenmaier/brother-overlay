...
SRC_URI="http://download.brother.com/welcome/dlf006265/brmfc7820nlpr-${PV}-${BR_PR}.i386.rpm
	http://download.brother.com/welcome/dlf006267/cupswrapperMFC7820N-${PV}-${BR_PR}.i386.rpm"
